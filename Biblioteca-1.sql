...
INSERT INTO Livro (ISBN, Título, Ano, Editora)
VALUES ('9788535902771', 'Cem Anos de Solidão', 1967, 'Editora Record');
INSERT INTO Livro (ISBN, Título, Ano, Editora)
VALUES ('9786586695047', 'Sapiens: Uma Breve História da Humanidade', 2011, 'L&PM Editores');
INSERT INTO Livro (ISBN, Título, Ano, Editora)
VALUES ('9788545702870', 'A Revolução dos Bichos', 1945, 'Companhia das Letras');
...
/*
=========================
Dados do relacionamento Tem(Autor_Livro)
=========================
*/

INSERT INTO Autor_Livro (Autor_ID, Livro_ISBN)
VALUES ('1726354', '9788535902771');
INSERT INTO Autor_Livro (Autor_ID, Livro_ISBN)
VALUES ('7654321', '9788545702870');
INSERT INTO Autor_Livro (Autor_ID, Livro_ISBN)
VALUES ('1234567', '9786586695047');

/*
=========================
Dados do relacionamento Empréstimo
=========================
*/

INSERT INTO Empréstimo (ISBN_Livro, Matricula_Aluno, DataEmprestimo, DataEDevolução)
VALUES ('9786586695047', '1726354', '2025-08-01', '2025-08-10');
INSERT INTO Empréstimo (ISBN_Livro, Matricula_Aluno, DataEmprestimo, DataEDevolução)
VALUES ('9788535902771', '7654321', '2025-08-20', '2025-08-30');
INSERT INTO Empréstimo (ISBN_Livro, Matricula_Aluno, DataEmprestimo, DataEDevolução)
VALUES ('9788545702870', '1234567', '2025-07-15', '2025-07-22');

/*
=========================
Dados do relacionamento Cursa
=========================
*/

INSERT INTO Cursa (Matricula_Aluno, Código_Curso, Código_Turma)
VALUES ('1726354', '3', '2');
INSERT INTO Cursa (Matricula_Aluno, Código_Curso, Código_Turma)
VALUES ('7654321', '2', '1');
INSERT INTO Cursa (Matricula_Aluno, Código_Curso, Código_Turma)
